# Eden CMS - Manual Técnico Completo
...
Eden CMS es un sistema de gestión de contenido basado en Next.js que permite crear páginas dinámicas mediante bloques modulares.
