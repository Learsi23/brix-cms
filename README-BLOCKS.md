# Eden CMS — Guía para crear Bloques
...
Este sistema es idéntico al de EdenCMS.Pro (.NET), traducido a TypeScript.
...
Esto es idéntico al formato de EdenCMS.Pro (.NET) — los datos son completamente portables entre ambos sistemas.
